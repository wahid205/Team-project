...
public class RoomPanel extends javax.swing.JDialog {
    ...
    private void displayToRoomTextField(int row)
    {
       // for(int i=0; combo_roomType.)
        ...
        tf_beds.setText(table_rooms.getModel().getValueAt(row, 2)+"");        check_wifi.setSelected((table_rooms.getModel().getValueAt(row, 4)+"").equals("true") ? true:false);        check_phone.setSelected((table_rooms.getModel().getValueAt(row, 6)+"").equals("true") ? true:false);
    ...
    private void roomObjectCreation()
    {
        ...
        room = new Room(null);        room.setBed_number(Integer.parseInt(tf_beds.getText()));        room.setHasWIFI(check_wifi.isSelected());        
