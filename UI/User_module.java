 ...
 */
package UI;
//import test1.room_service;
//import test1.customers;

import test1.*;

//import test1.service;
...
public class User_module extends javax.swing.JFrame {
   ...
   NewCustomer.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       dispose();
   Employee NewEmoloyee=new Employee();
   NewEmoloyee.setVisible(true);
   ...
   NewService.setVisible(true);
    ...
    dispose();
   room_service ForNewService=new room_service();
   ForNewService.setVisible(true);
